...
/**
 * Seller Products Page Component
 * Manage products for the logged-in seller
 */
                  ...
                  <tr key={product.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <div className="flex space-x-3">
                        <Link to={`/seller/edit-product/${product.id}`} className="text-blue-600 hover:text-blue-900">
